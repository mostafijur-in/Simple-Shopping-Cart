...
6. By default 1 admin account will be created with the user name `tonystark@ironman.ms` and password `HelloJarvis`.
7. Admin URL: [http://127.0.0.1:8000/admin](http://127.0.0.1:8000/admin)
